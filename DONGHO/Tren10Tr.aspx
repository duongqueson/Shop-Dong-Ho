<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageItems.Master" AutoEventWireup="true" CodeBehind="Tren10Tr.aspx.cs" Inherits="DONGHO.Tren10Tr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDsGiaDuoi2" runat="server" ConnectionString="<%$ ConnectionStrings:DONGHOConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([DonGia] &gt; @DonGia)">
        <SelectParameters>
            <asp:Parameter DefaultValue="10000000" Name="DonGia" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
