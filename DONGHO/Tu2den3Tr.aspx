<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageItems.Master" AutoEventWireup="true" CodeBehind="Tu2den3Tr.aspx.cs" Inherits="DONGHO.Tu2den3Tr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDsGiaDuoi2" runat="server" ConnectionString="<%$ ConnectionStrings:DONGHOConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE (([DonGia] &lt;= @DonGia2) AND ([DonGia] &gt;= @DonGia))">
        <SelectParameters>
            <asp:Parameter DefaultValue="3000000" Name="DonGia2" Type="Int32" />
