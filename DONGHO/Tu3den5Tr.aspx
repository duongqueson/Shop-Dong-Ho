<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageItems.Master" AutoEventWireup="true" CodeBehind="Tu3den5Tr.aspx.cs" Inherits="DONGHO.Tu3den5Tr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDsGiaDuoi2" runat="server" ConnectionString="<%$ ConnectionStrings:DONGHOConnectionString %>" SelectCommand="SELECT * FROM [SANPHAM] WHERE (([DonGia] &lt;= @DonGia2) AND ([DonGia] &gt;= @DonGia))">
        <SelectParameters>
            <asp:Parameter DefaultValue="5000000" Name="DonGia2" Type="Int32" />
            <asp:Parameter DefaultValue="3000000" Name="DonGia" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
